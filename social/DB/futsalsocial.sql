...
--
-- Host: localhost
-- Generation Time: May 28, 2017 at 12:00 PM
...
--
-- Table structure for table `member_status_comment`
--

CREATE TABLE IF NOT EXISTS `member_status_comment` (
  `status_comment_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `member_status_like`
--

CREATE TABLE IF NOT EXISTS `member_status_like` (
  `status_like_id` int(11) NOT NULL AUTO_INCREMENT,
  `status_id` int(11) NOT NULL,
  PRIMARY KEY (`status_like_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
